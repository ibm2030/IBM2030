...
RW_LCH: FL port map(clk=>sysclk, S=>RD_SEL,R=>WR_SEL,Q=>RW_CTRL_STACK); -- BE3J5
...
LS_LCH: PH port map(clk=>sysclk, D=>MAIN_STORAGE_CP_N,L=>sGT_LOCAL_STG,Q=>LOCAL_STORAGE_CP); -- AA1F4
MS_LCH: PH port map(clk=>sysclk, D=>EARLY_LOCAL_STG_N,L=>sGT_LOCAL_STG,Q=>MAIN_STORAGE); -- AA1F4
