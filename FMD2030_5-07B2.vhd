...
GT_CS_OPT: FL port map(clk=>sysclk, S=>GT_CS_OPT_Set, R=>GT_CS_OPT_Reset, Q=>GT_CS_OPT_DECODER); -- AB3E5
...
S_REG: FLV port map(clk=>sysclk, S=>S_REG_Set, R=>S_REG_Reset, Q=>S); -- AA3G7, AA3H7, AA3J7, AA3K7
END FMD;
