...
-- Command     : write_vhdl -force -mode funcsim -rename_top zybo2030_clk_wiz_0_0 -prefix
--               zybo2030_clk_wiz_0_0_ zybo2030_clk_wiz_0_0_sim_netlist.vhdl
...
entity zybo2030_clk_wiz_0_0_zybo2030_clk_wiz_0_0_clk_wiz is
  port (
...
end zybo2030_clk_wiz_0_0_zybo2030_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of zybo2030_clk_wiz_0_0_zybo2030_clk_wiz_0_0_clk_wiz is
  signal clk_in1_zybo2030_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_zybo2030_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_zybo2030_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out2_zybo2030_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_zybo2030_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_out3_zybo2030_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_zybo2030_clk_wiz_0_0_en_clk : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_out1_zybo2030_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out1,
...
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => clk_out2_zybo2030_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out2,
...
clkout3_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg3(7),
      CE1 => '0',
      I0 => clk_out3_zybo2030_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out3,
...
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT0 => clk_out1_zybo2030_clk_wiz_0_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_zybo2030_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset,
      D => locked_int,
      Q => seq_reg1(0)
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_zybo2030_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset,
      D => locked_int,
      Q => seq_reg2(0)
...
\seq_reg3_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out3_zybo2030_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset,
      D => locked_int,
      Q => seq_reg3(0)
...
entity zybo2030_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of zybo2030_clk_wiz_0_0 : entity is true;
end zybo2030_clk_wiz_0_0;

architecture STRUCTURE of zybo2030_clk_wiz_0_0 is
begin
inst: entity work.zybo2030_clk_wiz_0_0_zybo2030_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
