...
#
# Script generated by Vivado on Thu Nov 20 21:25:37 CET 2025
# SW Build 6233196 on Thu Sep 11 21:27:11 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_mem_64k_9.sh
...
#
# Usage        : blk_mem_64k_9.sh
#                blk_mem_64k_9.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_64k_9.sh [-reset_run]
#                blk_mem_64k_9.sh [-reset_log]
#                blk_mem_64k_9.sh [-help]
#
...
#                script (type 'blk_mem_64k_9.sh -help' for more information).
#
...
# script info
echo -e "blk_mem_64k_9.sh - Script generated by export_simulation (Vivado v2025.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_64k_9.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../../../../../../mnt/LJW2025/Xilinx/2025.1.1/data/rsb/busdef" +incdir+"/mnt/LJW2025/Xilinx/2025.1.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../mnt/LJW2025/Xilinx/2025.1.1/data/rsb/busdef" +incdir+"/mnt/LJW2025/Xilinx/2025.1.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blk_mem_64k_9 xil_defaultlib.glbl -o blk_mem_64k_9_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blk_mem_64k_9_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_64k_9_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_64k_9_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_64k_9.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_64k_9.sh [-help]\n\
Usage: blk_mem_64k_9.sh [-step]\n\
Usage: blk_mem_64k_9.sh [-lib_map_path]\n\
Usage: blk_mem_64k_9.sh [-reset_run]\n\
Usage: blk_mem_64k_9.sh [-reset_log]\n\
Usage: blk_mem_64k_9.sh [-keep_index]\n\
Usage: blk_mem_64k_9.sh [-noclean_files]\n\n\
