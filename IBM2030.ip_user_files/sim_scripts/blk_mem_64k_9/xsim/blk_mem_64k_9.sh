...
#
# Script generated by Vivado on Mon Oct 06 14:17:53 +0200 2025
...
# script info
echo -e "blk_mem_64k_9.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_64k_9 xil_defaultlib.blk_mem_64k_9 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_64k_9 -key {Behavioral:sim_1:Functional:blk_mem_64k_9} -tclbatch cmd.tcl -log simulate.log
}
