...
export RDI_DATADIR="/mnt/LJW2025/Xilinx/2025.1.1/data"

# set xvlog options
xvlog_opts="--relax  -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L smartconnect_v1_0 -L xilinx_vip"
...
elaborate()
{
  xelab --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_64k_9 xil_defaultlib.blk_mem_64k_9 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_64k_9 -key {Behavioral:sim_1:Functional:blk_mem_64k_9} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c662.protoinst" -protoinst "protoinst_files/zybo2030.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/mnt/LJW2025/Xilinx/2025.1.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_mem_64k_9.wdb xsim.dir libdpi.so)
