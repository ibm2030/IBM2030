...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../../../mnt/LJW2025/Xilinx/2025.1.1/data/rsb/busdef" +incdir+"/mnt/LJW2025/Xilinx/2025.1.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../mnt/LJW2025/Xilinx/2025.1.1/data/rsb/busdef" +incdir+"/mnt/LJW2025/Xilinx/2025.1.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.blk_mem_64k_9 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.blk_mem_64k_9 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log blk_mem_64k_9_sc.so .tmp_log xcelium_lib waves.shm c.obj)
